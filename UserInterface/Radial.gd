...
func _draw() -> void:
	...
	if ring:
		draw_ring_arc(offset, radius, radius-thickness, 0.0, TAU, bg_color)
		draw_ring_arc(offset, radius, radius-thickness, 0.0, angle, bar_color)
	else:
		draw_circle_arc(offset, radius, 0.0, TAU, bg_color)
		draw_circle_arc(offset, radius, 0.0, angle, bar_color)
		draw_circle_arc(offset, radius - thickness, 0.0, TAU, bg_color)
